...
class OneVsAll(object):
    ...
    def calc_z(self,KLRG_model,X_train,X_test,y_train,KernelMat):
        ...
        for i in range(self.num_labels):
            ...
            alphas, conver = KLRG_model.SGD(KernelMat, X_train, y_train[:, i])
...
if __name__ == '__main__':
    ...
    np.savetxt("/home/donjy/datasets/gen_datas/SGD_Z_indian_{}.csv".format(test_size), all_z[:, :], delimiter=',')
